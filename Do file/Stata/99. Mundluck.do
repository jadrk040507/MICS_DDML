...
cap program drop start_clean
program define   start_clean
...
save "${Data}MASTER_MICS_RF.dta", replace

end

cap program drop start_clean_Diarrhea
program define   start_clean_Diarrhea
use "${Data}MASTER_MICS_U4_INDIV_U5_WQ.dta", clear
...
-----------------------------*/
start_clean
bys Cluster_var: egen water_treatment_mean=mean(water_treatment)

reg  WQ26 i.water_treatment 
areg WQ26 i.water_treatment ,absorb(Cluster_var)
reg  WQ26 i.water_treatment water_treatment_mean

reg  HH_child_diarrhea i.water_treatment 
areg HH_child_diarrhea i.water_treatment ,absorb(Cluster_var)
reg  HH_child_diarrhea i.water_treatment water_treatment_mean
