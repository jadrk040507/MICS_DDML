...
*===============================================================
* Diarrhea: Akito to make child level data
*===============================================================
...
* use "/Users/akitokamei/Library/CloudStorage/Dropbox/MICS_DDML/Data/3. Final/MASTER_MICS_U4_INDIV_U5_AAL_CLEAN.dta", clear
    ...
    * LaTeX fragment for Panel A (basic)
    esttab using "${Tables}Est_OLS_`i'.tex", ///
        ...
        varlabels( ///
            ...
            3.WQ15_g "Strain" 98.WQ15_g "Other treatment" 99.WQ15_g "Do not know" ///
        ) ///
        star(* .10 ** .05 *** .01) b(3) ///
