...
# =============================================================================
# HETEROGENEITY: GATE and GAPO group indicators
# =============================================================================
#
# Group splitters used by both:
#   - GATE: APOS contrast E[Y(d)-Y(0)|group].
#   - GAPO: APOS level E[Y(d)|group].
# RiskSource is valid here: pre-treatment source-water risk splitter, not a
# main-effect confounder in the headline model.
GATE_GROUPS = [
